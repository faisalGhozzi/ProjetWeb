...
//$listeCategory=$categoryTmpC->afficherCategories();
$hostname = "localhost";
$username = "root";
$password = "khalil123";
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    <h3>Product Info</h3>
                                    <form method="POST" action="ajoutProduct.php">
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <select style="width:500px" name="cid"> 
                                                   <?php while($row1 = mysqli_fetch_array($result1)):;?>
                                                   <option><?PHP echo $row1['category_id'];?>
                                                   </option>
                                                   <?php endwhile;?>
                                                </select> 
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label>Elastic</label>
                                                <select style="width:500px" name="eid"> 
                                                   <?php while($row2 = mysqli_fetch_array($result2)):;?>
                                                   <option><?PHP echo $row2['elastic_id'];?>
                                                   </option>
                                                   <?php endwhile;?>
                                                </select>
                                             </p>
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <p>
                                                ...
                                                <input type="text" placeholder="Enter Discount as Percentage" name="promotion">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="col-md-6 col-sm-6"> 
                                                ...
                                                <div class="row">
                                                   <div class="col-md-12">
                                                      <div class="product-upload-image">
                                                         <!-- hide image tag -->
                                                         <img src="" style="display:none;" height="200" id="imageFace">
                                                         <!-- preview Trigger -->
                                                ...
                                                <h3>Tail Image</h3>
                                                   <div class="row">
                                                      <div class="col-md-12">
                                                         <div class="product-upload-image">
                                                            <!-- hide image tag -->
                                                         <img src="" style="display:none;" height="200" id="imageTail">
                                                         <!-- preview Trigger -->
                                                         <input class="btn btn-success" type="file" name="imgTail" onchange="showImage.call(this)">
                                                         <script>
                                                               function showImage()
                                                               {
                                                                  if(this.files && this.files[0])
                                                                  {
                                                                     var obj = new FileReader();
                                                                     obj.onload = function(data){
                                                                           var image = document.getElementById("imageTail");
                                                                           image.src = data.target.result;
                                                                           image.style.display = "block";
                                                                     }
                                                                     obj.readAsDataURL(this.files[0]);
