        ...
        <section class="row justify-content-center">  
            ...
            ?>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="card">
                        <div class="front">
                            <?PHP echo "<img src=\"image/{$row['product_imgFace']}\" class=\"image1\">" ?>
                        </div>
                        <div class="back">
                            <?PHP echo "<img src=\"image/{$row['product_imgTail']}\" class=\"image1\">" ?>
                        </div>
                    </div> 
                    <form method="POST" action="AjouterPanier.php?id=<?php echo $row ['product_id'];?>" > 
                        <input type="number"  name="qte" >
                                <button class="btn btn-primary" type="submit" name="ajouter" value="ajouter">Ajouter au panier</button> 
                    </form>   
                </div> 
