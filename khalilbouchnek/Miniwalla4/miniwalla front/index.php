                ...
                <section class="container-fluid"> 
                        <section class="row justify-content-center">
                            <section class="col-12 col-sm-6 col-md-6 col-lg-4">
                                <form id="zoom-in-effect" class="form-container" action="login.php" method="POST">
                                    ...
                                    <button name="submit" type="submit" class="btn btn-primary btn-block submit-btn">Submit</button>
                                    <hr>
