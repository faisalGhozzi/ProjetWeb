                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="ecommerce">
                           ...
                           <li class="active"><a href="add-service.html">add New Service</a></li>  
                                    ...
                                    <form method="POST" action="ajoutService.php" >
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" placeholder="Enter Service ID"  name="id"  class="form-control" required >
                                                <?php
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <p>
                                                <label>Type</label>
                                                <input type="text" placeholder="Enter Type Name"  name="type"   class="form-control" required >
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-6">
                                             <p>
                                                <label>Numero</label>
                                                <input type="text" placeholder="+216"  name="numero" maxlength=8 size=8 required pattern ="[0-9]{8}" class="form-control"  >
                                             </p>
                                          </div> 
                                          <!--maxlength=8 size=8 required pattern ="[0-9] {8}-->
                                          
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <button type="submit" class="btn btn-success" name="ajouter" value="ajouter" >
                                                <i class="fa fa-check"></i>
                                                Save Info
                                                </button>
