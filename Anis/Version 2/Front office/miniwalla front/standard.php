<?PHP
include "../Tbackend/themescare.com/demos/seipkon-admin-template/productC.php";
...
<head>
    ...
    <title>miniWalla | Standard</title>
</head>
...
<body>
    ...
    <section class="container-fluid center-all">
        <section class="row justify-content-center">
            <?PHP
            ...
            ?>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="card">
                        <div class="front">
                            <?PHP echo "<img src=\"../Tbackend/themescare.com/demos/seipkon-admin-template/image/{$row['product_imgFace']}\" class=\"image1\">" ?>
                            <?PHP echo "<img src=\"../Tbackend/themescare.com/demos/seipkon-admin-template/image/black.png\" class=\"image2\" >" ?>
                        </div>
                        <div class="back">
                            <?PHP echo "<img src=\"../Tbackend/themescare.com/demos/seipkon-admin-template/image/{$row['product_imgTail']}\" class=\"image1\">" ?>
                            <?PHP echo "<img src=\"../Tbackend/themescare.com/demos/seipkon-admin-template/image/black.png\" class=\"image2\">" ?>
                        </div>
                    </div>
                    <input type="button" class="btn btn-primary" value="Pick Me">
                </div>
            <?PHP
            }
            ?>
