...
<!-- Mirrored from themescare.com/demos/seipkon-admin-template/order-list-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Feb 2019 17:02:49 GMT -->
<head>
   ...
   <body>
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="ecommerce">
                           ...
                           <li class="active"><a href="order-list-product.html">product order list</a></li> 
	...
	<td><form method="POST" action="supprimerService.php">  

	<input type="submit" class="product-table-danger" data-toggle="tooltip"  name="supprimer" value="supprimer"><i class="fa fa-trash"></i> 
	<input type="hidden" value="<?PHP echo $row['service_id']; ?>" name="id">
	</form>
	</td>
	<td><a href="edit-service.php?id=<?PHP echo $row['service_id']; ?>">
	Modifier</a></td>
	</tr>
	<?PHP
}
...
<!-- Mirrored from themescare.com/demos/seipkon-admin-template/order-list-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Feb 2019 17:02:50 GMT -->
</html>