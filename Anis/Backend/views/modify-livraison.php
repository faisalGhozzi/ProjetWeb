...
<head>
	  ...
	  var setLink = function (){
		 ...
		 window.location.replace("http://127.0.0.1/backend/views/modify-livraison.php?ref="+ref);
	  };
	  var check = function()
	  {
		  if(window.location.href=="http://127.0.0.1/backend/views/modify-livraison.php"){
			 var ref = f.pref.value;
