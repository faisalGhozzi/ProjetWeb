...
<head>
	  ...
	  var setLink = function (){
		 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/Tbackend/themescare.com/demos/seipkon-admin-template/modifierPromotion.php?idc="+id);
	  };
	  var check = function()
	  {
		  if(window.location.href=="http://127.0.0.1/Tbackend/themescare.com/demos/seipkon-admin-template/modifierPromotion.php"){
			 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/Tbackend/themescare.com/demos/seipkon-admin-template/modifierPromotion.php?idc="+id);
		  }
	  };
					...
					<!-- MENU Gestion des Clients --> 
					 <li>
                        ...
                        <ul class="collapse list-unstyled" id="gestionClients">
                           <li><a href="AjoutClient.html">Ajouter Client</a></li>
						   <li><a href="#">Modifier Client</a></li>
						   <li><a href="#">Supprimer Client</a></li>
						   <li><a href="AfficherClients.html">Afficher la liste des Clients</a></li>
                        </ul>
                     </li>
					 ...
					 <li>
                        ...
                        <ul class="collapse list-unstyled" id="gestionAdmins">
                           <li><a href="AjouterAdmin.html">Ajouter Admin</a></li>
						   <li><a href="#">Modifier Admin</a></li>
						   <li><a href="#">Supprimer Admin</a></li>
						   <li><a href="#">Afficher la liste des Admins</a></li>
                        </ul>
                     </li>
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input id="PromV"type="number" min=0 max=100 name="pValue" id="pValue" value="<?php echo   $row['tauxPromo']; ?>">
                                             </p>
                                          </div>
                                       </div>
									   <?php $resultat=null ?>
