...
class LivraisonC{
	...
	{
		$sql="insert into livraison (Adresse_livraison,Num_Tel,Gouvernorat,id_client,id_panier,statut) values (:Adresse_livraison,:Num_Tel,:Gouvernorat,:id_client,null,'en cours de verification')";
