...
$livraisonC->SupprimerLivraison($_POST['pref']);
...
if(isset($_GET['ref']))
{
 ...
 $resultat=$livraisonC->rechercherlivraison($_GET['ref']);
...
<head>
	  ...
	  var setLink = function (){
		 var ref = f.pref.value;
		 window.location.replace("http://127.0.0.1/tBackend/themescare.com/demos/seipkon-admin-template/delete-livraison.php?ref="+ref);
	  };
	  var check = function()
	  {
		  if(window.location.href=="http://127.0.0.1/tBackend/themescare.com/demos/seipkon-admin-template/delete-livraison.php"){
			 var ref = f.pref.value;
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    <h3>Supprimer une livraison</h3>
                                    <form name="f" method="POST" action="delete-livraison.php">
                                                                            <div class="row">
                                          <div class="col-md-12">
                                             <p>
											   ...
											   ?>
											   <option id="<?PHP echo $id['reference']?>"><?PHP echo $id['reference'] ?></option>
											   <?PHP } ?>
											   </select>
                                             </p>
                                          </div>
									   ...
									   <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" readonly value="<?PHP foreach($resultat as $row){echo $row['Adresse_livraison'];} ?>" name="Adresse_livraison" required>
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" readonly value="<?PHP echo $row['Num_Tel'];?>" name="Num_Tel"  maxlength=8 size=8 required pattern="[0-9]{8}">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          ...
                                          <div class="col-md-6">
                                             <p>
                                                <label>Gouvernorat </label>
                                                                                             <select name="gov">
													<input type="text" readonly value="<?PHP echo $row['Gouvernorat'];?>" ></input>   
                                             </p>
                                          </div>
                                       </div>
