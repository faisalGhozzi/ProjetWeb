                        ...
                        <?php endif ?> <li class="nav-item">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    ...
                                    <a class="dropdown-item" href="ethnic.php">Ethnic</span>
                                    <a class="dropdown-item" href="secret message.php">Secret message</a>
                                    <span class="dropdown-item active">Carbon</span>
                                </div>
                            </div>
                        </li>
    ...
    <div class="container-fluid drop-top">
        <div class="row justify-content-center">
            ...
            foreach ($listeProducts as $row) {
                if ($row['category_name'] == 'Carbon Wallets') {
                    ?>
