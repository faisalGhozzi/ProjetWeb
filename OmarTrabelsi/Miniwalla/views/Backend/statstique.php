...
if (!isset($_SESSION['user_id'])) {
 ...
 $query = "select count(*) as number from codepromo 
where date_Debut < cast(now() as date) and date_Fin < cast(now() as date)
"; 

 $query1 = "select count(*) as number from codepromo 
where date_Debut > cast(now() as date) and date_Fin > cast(now() as date)
"; 
		...
		google.charts.load('current', {packages: ['corechart', 'bar']});
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ['Status','Coupons', { role: 'style' }], 
                          <?php  
                          while($row = mysqli_fetch_array($result))  
                          { 
							   echo "['Inactive Coupons', ".$row["number"].",'red'],";  
						  }							   
                          ...
                          { 
							   echo "['Active Coupons', ".$row1["number"].",'green']";  
						  }							   
      ...
      <div class="wrapper">
         ...
         <header class="main-header">
            ...
            <div class="seipkon-logo">
               <a href="index.php">
               <img src="assets/img/logo0.png" style="filter:invert(100%);" alt="logo">
               </a>
            </div>
            <!-- Logo End -->
