                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                            ...
                                            <?PHP
                                             ...
                                             if (isset($_GET['id'])) {
                                                ...
                                                foreach ($result as $row) {
                                                   ...
                                                   $eid = $row['elastic_id'];
                                                   ?>
                                            <form name="myForm"  method="POST" action="edit-product.php">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p>
                                                            <label>Price</label>
                                                            <input type="text" placeholder="Enter Price" name="price" value=<?php echo $row['product_price'] ?>>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p>
                                                            ...
                                                            <input type="text" placeholder="Enter Discount as Percentage" name="promotion" value=<?php echo $row['product_promotion'] ?>>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                       ...
                                       if (isset($_POST['modifier'])) {
                                          $product = new Product($_POST['imgFace'], $_POST['imgTail'], $_POST['price'], $_POST['promotion'], $_POST['cid'], $_POST['eid']);
