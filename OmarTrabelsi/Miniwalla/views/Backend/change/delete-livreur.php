...
$livreurC->SupprimerLivreur($_POST['pid']);
...
<head>
	  ...
	  var setLink = function (){
		 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/backend/views/delete-livreur.php?id="+id);
	  };
	  var check = function()
	  {
		  if(window.location.href=="http://127.0.0.1/backend/views/delete-livreur.php"){
			 var id = f.pid.value;
		 window.location.replace("http://127.0.0.1/backend/views/delete-livreur.php?id="+id);
		  }
	  };
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    <h3>Supprimer un livreur</h3>
                                    <form name="f" method="POST" action="delete-livreur.php">
                                                                            <div class="row">
                                          <div class="col-md-12">
                                             <p>
									   ...
									   <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" readonly value="<?PHP foreach($resultat as $row){echo $row['Nom_societe'];} ?>" name="nom_societe">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="number" readonly value="<?PHP echo $row['Num_Tel'];?>" name="Num_Tel">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" readonly value="<?PHP echo $row['Adresse_mail'];?>" name="Adresse_mail">
                                             </p>
                                          </div>
                                       </div>
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <p>
                                                <label>Adresse </label>
                                                <input type="text" readonly value="<?PHP echo $row['Adresse'];?>" name="Adresse">
                                             </p>
                                          </div>
                                       </div>
									   <div class="row">
