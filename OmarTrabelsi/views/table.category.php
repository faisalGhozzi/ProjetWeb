                           ...
                           <div class="table-responsive advance-table">
                              <table id="button_datatables_example" class="table display table-striped table-bordered">
                                ...
                                foreach($listeCategory as $row){
                                    ...
                                    <a href="edit-category.php?id=<?PHP echo $row['category_id']; ?>" class="product-table-info" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                    </td>
                                    </tr>
                                    <?PHP 
                                 } 
