...
unset($_SESSION['ELivraison']);
if(isset($_SESSION['user_id']))
{
	$resultat=$LivraisonC->RechercherLivraison($_SESSION['user_id']);
	$connect = mysqli_connect("localhost", "root", "", "projet");
	$id=$_SESSION['user_id'];
	 $query = "select * from livraison where id_client=$id"; 
	 $result = mysqli_query($connect, $query); 
	  if(mysqli_num_rows($result)==0)
	{
		$_SESSION['ELivraison']="You dont have any delivery";
	}else
	{
		$resultat=$LivraisonC->RechercherLivraison($_SESSION['user_id']);
	}
...
?>
<?php if(isset($_SESSION['ELivraison'])){echo $_SESSION['ELivraison']; } ?>
