        ...
        <div class="row justify-content-center">
            ...
            <form method="POST" action="buyPage.php?id=<?php echo $row['product_id']?>">
                <div class="col-12 col-sm-12 col-md-6 col-lg-3">
                    <div class="card">
                        <div class="front">
                            <?PHP echo "<img src=\"../Backend/views/image/{$row['product_imgFace']}\" class=\"image1\">" ?>
                            <?PHP echo "<img src=\"../Backend/views/image/{$row['elastic_img']}\" class=\"image2\" >" ?>
                        </div>
                        <div class="back">
                            <?PHP echo "<img src=\"../Backend/views/image/{$row['product_imgTail']}\" class=\"image1\">" ?>
                            <?PHP echo "<img src=\"../Backend/views/image/{$row['elastic_img']}\" class=\"image2\">" ?>
                        </div>
                    </div>
