...
<body>
                        ...
                        <tbody> 
                            ...
                            foreach ($listePanier as $row) {
                                ...
                                <form method="POST" action="ModifierPanier.php">
                                        <td>
                                            <div class="card">
                                                <?PHP echo "<img src=\"../Backend/views/image/{$data['product_imgFace']}\" class=\"image1\">" ?>
                                                <?PHP echo "<img src=\"../Backend/views/image/{$data['elastic_img']}\" class=\"image2\">" ?>
                                            </div>
                                        </td>
    ...
    <script src="javaScript/bootstrap-input-spinner.js">
    </script>
    <script>
