                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="add-product-form-group">
                                            <h3>Product Info</h3>
                                            <form name="myForm" action="ajoutProduct.php" onsubmit="return validate_product()" method="POST">
                                                <div class="row" style="display:none">
                                                    <div class="col-md-12">
                                                        <p>
                                                            <label>ID</label>
                                                            <input type="number" placeholder="Enter ID" name="id" class="form-control">
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p>
                                                            ...
                                                            <input type="text" placeholder="Enter Discount as Percentage" name="promotion" value="0" id="promotion" class="form-control">
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <p>
                                                            <button type="submit" class="btn btn-success" value="submit" name="ajouter">
                                                                <i class="fa fa-check"></i>
                                                                Save Info
                                                            </button>
                                                        </p>
