                     ...
                     <div class="pull-left">
                        ...
                        <div class="header-top-search">
                           <form action = "verifform.php" method = "get">
                              <input type="search" placeholder="Search..."   name = "terme" >
                              <button type="submit" name = "s" value="Rechercher"><i class="fa fa-search"></i></button>
                           </form>
                        </div>
...
foreach($listeEmployes as $row){
   ...
   <a href="supprimerCommande.php?reference=<?PHP echo $row['reference']; ?>"><input type="submit" name="supprimer" value="supprimer"></a>
