                              ...
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    ...
                                    if (isset($_GET['id'])){
                                        ...
                                        $result=$elasticC->recupererElastiques($_GET['id']);
                                                ...
                                                <div class="row">
                                                   <div class="col-md-12">
                                                      <div class="product-upload-image">
                                                        <?PHP echo "<img src=\"image/{$row['elastic_img']}\" Id=\"image\">"?> 
                                    ...
                                    <?PHP
                                       ...
                                       if (isset($_POST['modifier'])){
                                          $elastic=new elastic($_POST['id_ini'],$_POST['img'],$_POST['name']);
