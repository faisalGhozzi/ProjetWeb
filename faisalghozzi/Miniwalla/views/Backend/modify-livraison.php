...
if (isset($_POST['Adresse_livraison'])and isset ($_POST['Num_Tel'])  and isset ($_POST['gov']) and isset ($_POST['pref']) )
{
...
<head>
	  ...
	  var setLink = function (){
		 ...
		 window.location.replace("http://127.0.0.1/tBackend/themescare.com/demos/seipkon-admin-template/modify-livraison.php?ref="+ref);
	  };
	  var check = function()
	  {
		  if(window.location.href=="http://127.0.0.1/tBackend/themescare.com/demos/seipkon-admin-template/modify-livraison.php"){
			 var ref = f.pref.value;
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    ...
                                    <form name="f" method="POST" action="modify-livraison.php">
                                                                            <div class="row">
                                          <div class="col-md-12">
                                             <p>
									   ...
									   <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" value="<?PHP foreach($resultat as $row){echo $row['Adresse_livraison'];} ?>" name="Adresse_livraison" required>
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
