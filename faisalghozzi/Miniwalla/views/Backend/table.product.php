                           ...
                           <div class="table-responsive advance-table">
                              <table id="button_datatables_example" class="table display table-striped table-bordered">
                                 ...
                                 ?>
                                    ...
                                    <td><?PHP echo "<img src=\"image/{$row['product_imgFace']}\">"?></td>
                                    <td><?PHP echo "<img src=\"image/{$row['product_imgTail']}\">"?></td>
                                    <td><?PHP echo $row['product_price']; ?></td>
                                    <td><?PHP echo $row['product_promotion']; ?></td>
                                    <td><?PHP echo $row['category_name']; ?></td>
                                    <td><?PHP echo "<img src=\"image/{$row['elastic_img']}\">"?></td> 
                                    <td><form method="POST" action="supprimerProduct.php">  
                                    ...
                                    <a href="edit-product.php?id=<?PHP echo $row['product_id']; ?>" class="product-table-info" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
                                    </td>
                                    </tr>
                                    <?PHP 
                                 } 
