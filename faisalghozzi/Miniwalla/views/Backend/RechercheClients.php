		...
		<div class=".col-md-6">
		  ...
		  <div class="form-group">
           <div class="input-group">
            ...
            <input type="text" name="search_text" id="search_text" placeholder="Search by Client Details" class="form-control" />
           </div>
         </div>
	       </div>
          </div>
        </div>
				<table class="table table-striped table-hover" id="main" style="">
				<thead>
				  <tr>
					<th>ID</th>
					<th>Last Name</th>
