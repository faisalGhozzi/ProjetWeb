                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="ecommerce">
                           ...
                           <li class="active"><a href="add-category.html">add New Category</a></li>
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    <h3>Category Info</h3>
                                    <form method="POST" onsubmit="return validate_category()" action="ajoutCategory.php" name="myForm">
                                       <div class="row" style="display:none">
                                             <div class="col-md-6">
                                                   <p>
                                                      <label>Category ID</label>
                                                      <input type="number" placeholder="Enter Category ID"  name="id" >
                                                   </p>
                                                </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-6">
                                             <p>
                                                ...
                                                <input type="text" placeholder="Enter Category Name"  name="nom" id="nom">
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
